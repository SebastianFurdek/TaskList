                    ...
                    <div class="project-item" style="position:relative;">
                        <div class="d-flex justify-content-between align-items-start w-100">
                            <div class="flex-grow-1 pe-3">
                                {{-- Make only the project title a clickable link, not the whole block --}}
                                <div class="project-title mb-1">
                                    <a href="{{ route('projects.show', $project->id) }}" class="text-decoration-none text-reset">{{ $project->name }}</a>
                                </div>

                                <div class="project-meta small mb-2">{{ \Illuminate\Support\Str::limit($project->description, 120) }}</div>

                                {{-- nested tasks for this project (use Bootstrap list-group-item so no .task-item hover applies) --}}
                                        ...
                                        <div class="list-group list-group-flush">
                                            @foreach($project->tasks as $ptask)
                                                <div class="list-group-item d-flex align-items-center py-2" data-task-id="{{ $ptask->id }}" data-complete-url="{{ route('tasks.complete', $ptask->id) }}">
                                                    ...
                                                    <div class="d-flex gap-2 align-items-center" style="position:relative; z-index:3;">
